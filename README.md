...
This library provides an implementation of the the `net::ViaductClient` HTTP requester based on on Mozilla's [viaduct](https://github.com/mozilla/application-services/tree/v90.0.1/components/viaduct) for its pluggable HTTP backend (eg. `reqwest` or `FFI` on Android).
